...
- [x] 2.5 Implement the sleep between cycles using `SCAN_INTERVAL` env var (default 300s)
- [x] 2.6 Add top-level `await` to start execution when the script is run directly
