...
async function runScript(args) {
  ...
  process.argv = ['node', 'import-mailbox-state.js', ...args];
  vi.resetModules();
  try {
    await import('../../../src/admin/import-mailbox-state.js');
  } finally {
...
describe('import-mailbox-state', () => {
  ...
  test('export then import round-trips the full bundle', async () => {
    // Mirrors export-mailbox-state.js's output shape directly, without
