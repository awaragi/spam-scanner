...
const { fakeImapClient, fakeRspamdClient, fakeAiClient, fakeStateManager } =
  await vi.hoisted(async () => {
    ...
    } = await import('../../../support/fake-clients.ts');
    return {
...
vi.mock('../../../../src/lib/clients/imap.client.ts', () => fakeImapClient);
vi.mock('../../../../src/lib/clients/rspamd.client.ts', () => fakeRspamdClient);
vi.mock('../../../../src/lib/clients/ai.client.ts', () => fakeAiClient);
vi.mock(
  '../../../../src/lib/clients/state-manager.client.ts',
  () => fakeStateManager
);

const { runScan } = await import(
  '../../../../src/lib/controllers/workflows/scan.controller.ts'
);
